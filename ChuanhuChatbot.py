...
my_api_key = "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"  # 在这里输入你的 API 密钥
...
if __name__ == "__main__":
    ...
    if dockerflag:
        if authflag:
            ...
            demo.queue().launch(server_name="0.0.0.0", server_port=7860, share=True, favicon_path="./assets/favicon.png")
